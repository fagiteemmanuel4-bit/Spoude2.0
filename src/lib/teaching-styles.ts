...
export const TEACHING_STYLES: TeachingStyle[] = [
  { id: "eli5", label: "Explain Like I'm 5", emoji: "🧒", blurb: "Plain words, tiny ideas, simple analogies.",
  ...
  { id: "socratic", label: "Socratic Coach", emoji: "🤔", blurb: "Guides you with questions before answers.",
  ...
  { id: "story", label: "Story Mode", emoji: "📖", blurb: "Teaches through a short narrative.",
  ...
  { id: "analogy", label: "Analogy First", emoji: "🪄", blurb: "Every concept gets a real-world analogy.",
    system: `${BASE}\n\nSTYLE: Analogy-first. For every concept, lead with a vivid real-world analogy, then give the precise definition.` },
  { id: "step", label: "Step-by-Step", emoji: "🪜", blurb: "Numbered steps from start to finish.",
  ...
  { id: "cram", label: "Exam Cram", emoji: "⚡", blurb: "Only the highest-yield facts, fast.",
  ...
  { id: "cheatsheet", label: "Cheat Sheet", emoji: "📝", blurb: "Dense reference page of key facts.",
    system: `${BASE}\n\nSTYLE: Cheat sheet. Output as a dense one-page reference: short headings, bullet lists, tables where useful. Minimal prose.` },
  { id: "mnemonic", label: "Memory Hooks", emoji: "🧠", blurb: "Mnemonics for every key concept.",
  ...
  { id: "real", label: "Real-World Examples", emoji: "🌍", blurb: "Concrete examples from daily life.",
  ...
  { id: "debate", label: "Two-Sided Debate", emoji: "⚖️", blurb: "Pros, cons, common misconceptions.",
  ...
  { id: "drill", label: "Q & A Drill", emoji: "❓", blurb: "Question → answer, repeat.",
  ...
  { id: "speed", label: "Speed Run", emoji: "🏃", blurb: "Ultra-compact one-pager.",
    system: `${BASE}\n\nSTYLE: Speed run. Compress the topic into the tightest possible lesson — under ~500 words. Headings, bullets, no filler.` },
  { id: "deep", label: "Deep Dive", emoji: "🔬", blurb: "Thorough, every nuance covered.",
  ...
  { id: "ladder", label: "Beginner → Advanced", emoji: "🪐", blurb: "Three passes: simple, deeper, expert.",
    system: `${BASE}\n\nSTYLE: Ladder. Teach the topic three times under headings "## Beginner", "## Intermediate", "## Advanced" — each level adding nuance.` },
  { id: "compare", label: "Compare & Contrast", emoji: "🆚", blurb: "Tables comparing concepts side-by-side.",
    system: `${BASE}\n\nSTYLE: Compare & contrast. Identify the key concepts and present them in markdown tables comparing properties side-by-side.` },
  { id: "case", label: "Case Study", emoji: "🗂️", blurb: "Worked example drives the lesson.",
  ...
  { id: "interleaved", label: "Quiz-As-You-Go", emoji: "🎯", blurb: "Short check-questions after each part.",
    system: `${BASE}\n\nSTYLE: Interleaved. After every section, insert a short "**Check:**" question and a one-line answer in italics below.` },
  { id: "recap", label: "TL;DR + Recap", emoji: "🧾", blurb: "Summary first, details second.",
    system: `${BASE}\n\nSTYLE: TL;DR. Start with a "## TL;DR" of 3 bullets, then expand each bullet under its own heading.` },
  { id: "outline", label: "Visual Outline", emoji: "🗺️", blurb: "Nested bullet outline of the topic.",
    system: `${BASE}\n\nSTYLE: Visual outline. Render the entire lesson as a nested bullet outline (- and indented -). Short labels, no long paragraphs.` },
  { id: "feynman", label: "Feynman Method", emoji: "🎓", blurb: "Teach it as if explaining to a friend.",
